...
**Primary Dataset:**
- Synthetic Product Launch Dataset — [GitHub](https://github.com/arora200/aplly_case_db/datasets/045-marketing-product-launch/)
- **Columns:** segment, population_lakhs, awareness_pct, consideration_pct, preference_pct, purchase_intent_pct, price_sensitivity, distribution_reach_pct, ad_spend_cr, competitor_ad_spend_cr, brand_loyalty_index
- **Rows:** 12 market segments

**Note:** Synthetic dataset for marketing case interview practice.
